...
public class FittedMarsRoverDomain extends HOPTranslate {
	...
	public FittedMarsRoverDomain(List<String> args) throws Exception {
...
//					outFile.flush();
	...
	public static void main(String[] args) throws Exception {
		...
		FittedMarsRoverDomain planner = new FittedMarsRoverDomain(
