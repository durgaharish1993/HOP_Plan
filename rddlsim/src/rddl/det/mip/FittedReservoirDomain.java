...
public class FittedReservoirDomain extends HOPTranslate {
	...
	public FittedReservoirDomain(List<String> args) throws Exception {
...
//
	...
	public static void main(String[] args) throws Exception {
		...
		FittedReservoirDomain planner = new FittedReservoirDomain(
